    ...
    <header class=" cor-bg-cabecalho">
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid fonte-tema">
                <a class="p-2" href="../paginas-ong/home-ong.php"><img src="../img/logo.png" width="200" alt="Logo do site AdotaPet"></a>
                <button class="navbar-toggler .custom-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
                    <span class="navbar-toggler-icon"></span>
                </button>
                <div class="collapse navbar-collapse" id="navbarNav">
                    <div class="navbar-nav ms-auto">
                        <a href="../paginas-ong/home-ong.php" class="nav-item cor-btn-cabecalho m-1" role="button">Pets</a>
                        ...
                        <a href="../paginas-ong/perfil.php" class=" nav-item cor-btn-cabecalho m-1 ms-2 me-2" role="button">Perfil</a>
                    </div>
                </div>
            </div>
        </nav>
