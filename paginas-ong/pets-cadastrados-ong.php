...
<div class="container fonte-fredoka">
  ...
  <table class="table table-striped fonte-tema">
    <thead>
      <tr>
    ...
    ?>
      <tbody>
        <tr>
          ...
          <td><a class="p-2" href="../crud/visualizar.php?id=<?php echo $um_registro['id_animal']; ?>"><img src="../img/icon-visualizar.png" width="30" alt="Icone de visualizar" title="Visualizar"></a>
